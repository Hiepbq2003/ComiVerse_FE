    ...
    <HomeLayout>
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <p style={{ color: '#94a3b8', fontSize: '16px', lineHeight: '1.7', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '22px', fontWeight: '600', color: 'white', margin: '0 0 16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '17px', fontWeight: '600', color: 'white', margin: '0 0 8px' }}>Community First</h3>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '17px', fontWeight: '600', color: 'white', margin: '0 0 8px' }}>Quality Content</h3>
            <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '17px', fontWeight: '600', color: 'white', margin: '0 0 8px' }}>Fair Monetization</h3>
            <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: '20px', fontWeight: '600', color: 'white', margin: '0 0 8px' }}>Want to learn more?</h3>
